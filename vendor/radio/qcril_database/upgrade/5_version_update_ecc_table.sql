...
DELETE FROM qcril_emergency_source_mcc_table where MCC = '413' AND NUMBER = '119';

DELETE FROM qcril_emergency_source_hard_mcc_table WHERE MCC = '413' AND NUMBER = '119';
